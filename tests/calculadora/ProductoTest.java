...
class ProductoTest {
    ...
    @Test
    @DisplayName("Prod1 Should throw exception when one of values is negative")
    ...
    @Test
    @DisplayName("Prod1 Should throw exception when one of values is zero")
    ...
    @Test
    @DisplayName("Prod1 Should return result when positive numbers are passed")
    ...
    @Test
    @DisplayName("Prod2 Should throw exception when one of values is negative")
    ...
    @Test
    @DisplayName("Prod2 Should throw exception when one of values is zero")
    ...
    @Test
    @DisplayName("Prod2 Should return result when positive numbers are passed")
    ...
    @Test
    @DisplayName("Prod3Nega Should throw exception when one of values is negative")
    ...
    @Test
    @DisplayName("Prod3Nega Should throw exception when one of values is zero")
    ...
    @Test
    @DisplayName(" Prod3Nega Should return result when positive numbers are passed")
    ...
    @Test
    @DisplayName("Pot1 Should throw exception when one of values is negative")
    ...
    @Test
    @DisplayName("Pot1 Should throw exception when one of values is zero")
    ...
    @Test
    @DisplayName("Pot1 Should return result when positive numbers are passed")
